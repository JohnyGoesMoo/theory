...
def en(text):
    new_text = ""  # empty str to hold en  for i in range(len(text)):  # loop through ever ch  if text[i] in ascii_lowercase:  # check if lowecase
...
Similar to the encryption function but shifts characters backward by the key value.
